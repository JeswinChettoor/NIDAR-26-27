...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/lidar_preprocessing"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lidar_preprocessing/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lidar_preprocessing/environment/path.sh"
